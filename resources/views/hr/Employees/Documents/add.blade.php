<form enctype="multipart/form-data" name="addEmployeesDocuments" id="addEmployeesDocuments" method="post" class="form-container">
    @csrf      
...
$(document).ready(function() {
    $('#addEmployeesDocuments').submit(function(e) {
    e.preventDefault();
        var name = $('#name').val();
...
//-------------------------------------------
$('#addEmployeesDocuments').submit(function () {
   
    var str = '';
    var counter = 1;
    event.preventDefault();
    $.ajax({
        url         : '/add_employee_documents',
        type        : 'post',
        ...
        success     : function ($result) {
            ...
            $('tbody').append("<tr><th scope='row'>"+counter+1+"</th><td>"+$result.documents.name+"</td><td>"+$result.documents.description+"</td><td>"+$result.documents.status+"</td><td>"+'<a data-toggle="edit_documents" href="/editview/'+$result.documents.id+'"><img src="/images/300-min.png" ></a>&nbsp;<a href="/employeedocuments/'+$result.documents.id+'"><img src="/images/400-min.png"></a>'+"</td></tr> ");
